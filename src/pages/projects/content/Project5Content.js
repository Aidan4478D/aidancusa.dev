...
export default function Project1Content() {
    return (
        <div className = "project-content-box">
            <h2>16-Bit CPU</h2>
            <p>
                During the month of April in the 2024 Spring Semester, Kristof 
                Jablonowski (EE'26) and I built a fullly functioning single‑cycle
                16‑bit CPU completely in Verilog. 
                
                Heavily referencing <i> Computer Organization and Design MIPS Edition </i>
                by Patterson and Hennessy, we designed the CPU according to MIPS
                Architecture but shrank everything into a tidy 16‑bit word.  

                We followed the Von Neumann Architecture style, creating components 
